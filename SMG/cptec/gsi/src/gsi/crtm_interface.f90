...
use gridmod, only: center_name, idlsm
use m_chars, only : uppercase
use cptecbam_crtm_mapping, only: map_cptec_surface_types, map_bam_to_crtm, finalize_cptec_crtm_mapping
...
! Mapping land surface type to CRTM surface fields
  ...
  case ('CPTEC')
     call map_cptec_surface_types(idlsm)
  case default
...
!$$$
  ...
  if(allocated(map_to_crtm_ir))deallocate(map_to_crtm_ir)
  if(allocated(map_to_crtm_mwave))deallocate(map_to_crtm_mwave)
